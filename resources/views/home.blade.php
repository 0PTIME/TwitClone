...
<div class="tweetComposer" id="mainContentId">
...
<div class="tweetComposer" style="display: none;"  id="pollContentId">
    <div class="tweetComposerBody">
        <div class="tweetComposerProfile">
            <img alt="loading" class="miniProfilePic" src="{{ route('profilePic', ['id' => auth()->user()->id,'size' => 50]) }}">
        </div>
                            ...
                            <div class="pollOption">
                                <div class="highlightArea">
                                    ...
                                    <div class="bottomOption">
                                        <input class="pollInput" type="text" name="option_one" id="optionOneInput" required>
                                    </div>
                                </div>
                            </div>
                            <div class="pollOption">
                                    <div class="highlightArea">
                                        ...
                                        <div class="bottomOption">
                                            <input class="pollInput" type="text" name="option_two" id="optionTwoInput" required>
                                        </div>
                                    </div>
                            </div>
                            <div class="pollOption">
                                <div class="highlightArea">
                                    ...
                                    <div class="bottomOption">
                                        <input class="pollInput" type="text" name="option_three" id="optionThreeInput">
                                    </div>
                                </div>
                            </div>
                            <div class="pollOption">
                                <div class="highlightArea">
                                    ...
                                    <div class="bottomOption">
                                        <input class="pollInput" type="text" name="option_four" id="optionFourInput">
                                    </div>
                                </div>
                            </div>
                        </div>
