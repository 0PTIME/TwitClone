...
jQuery('.bigCoverOpacity').click(function () {
  document.getElementById('bigCoverupOpacity').style.display = "none"; // document.getElementById('genericId').style.display = "none";    
...
__webpack_require__(/*! /mnt/c/users/enochc/localdev/twitclone/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /mnt/c/users/enochc/localdev/twitclone/resources/sass/app.scss */"./resources/sass/app.scss");
